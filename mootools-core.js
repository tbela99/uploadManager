...
this.Tips = new Class({
	...
	hide: function(element){
		...
		/*
		 * compat-mootools-additions, fix bugs in the mootools-compat
		 * @see http://www.siafoo.net/article/62
		 */
		/*
 ...
 */
		...
		// function $A(iterable){
		    ...
		    // return Array.prototype.slice.call(iterable);
		// }
		// alert(Ajax.prototype.initialize);
}
